...
export default function LogsPage() {
  ...
  return (
    <div>
      ...
      {logs.length === 0 ? (
        <div className="text-center py-12 futuristic-form rounded-2xl">
        ...
        <div className="futuristic-table relative rounded-2xl overflow-hidden">
          <table className="w-full">
            ...
            <tbody>
              {logs.map(log => (
                <tr key={log.id} className="border-b border-nexus-border/50 transition-colors hover:bg-white/[0.02]">
